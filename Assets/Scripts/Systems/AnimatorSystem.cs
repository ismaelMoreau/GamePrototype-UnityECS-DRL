...
partial struct AnimatorSystem : ISystem
{
    public void OnUpdate(ref SystemState state)
    {
        ...
        foreach (var (ltw, animator, enemyActionComponent, enemyActionTimerComponent) in SystemAPI.Query<LocalToWorld, SystemAPI.ManagedAPI.UnityEngineComponent<Animator>, EnemyActionComponent,EnemyActionTimerComponent>())
        { 
            //animator.Value.transform.SetPositionAndRotation(ltw.Position, ltw.Rotation);
